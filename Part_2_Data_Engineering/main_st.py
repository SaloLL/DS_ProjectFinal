...
def recomendacion_cliente(df, cliente_id, estado, num_recomendaciones, categoria=None):
    ...
    try:
        ...
        for indice in indices_top_recomendaciones:
            restaurante = df_otras_reseñas.iloc[indice]['name_x']
    ...
    for restaurante in restaurantes_recomendados:
        if categoria and categoria.lower() != 'all':
            df_restaurante = df_otras_reseñas[(df_otras_reseñas['name_x'] == restaurante) & (df_otras_reseñas['category'].str.lower() == categoria.lower())]
        else:
            df_restaurante = df_otras_reseñas[df_otras_reseñas['name_x'] == restaurante]
